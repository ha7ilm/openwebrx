    ...
    def do_GET(self):
        ...
        try:
            ...
            if self.path[:4]=="/ws/":
                ...
                if extension == "wrx" and ( (not anyStringsPresentInUserAgent(("Chrome","Firefox","Googlebot","iPhone","iPad","iPod"))) if 'user-agent' in list(self.headers.keys()) else True ) and (not request_param.count("unsupported")):
